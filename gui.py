    ...
    #escribir la ruta en el archivo input
        ...
        try:
            ...
            if abs(espesor_found - espesor) >= 0.15:
                ...
                messagebox.showerror("Error", f"No se encontró el insumo de la pieza {sldprt_file} con el espesor correcto. Por favor verifique que la chapa con el espesor de la pieza está cargado en el archivo de insumos correctamente: {str(e)}")
                print(f"No se encontró el insumo de la pieza {sldprt_file} con el espesor correcto. Por favor verifique que la chapa con el espesor de la pieza está cargado en el archivo de insumos correctamente: {str(e)}")
                error = True
                return
